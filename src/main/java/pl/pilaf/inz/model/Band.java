...
public class Band implements Serializable {
    ...
    public Band(long id, String name, String description, Date createdDate,
	    String createdPlace, List<User> members, String gengre) {
	super();
	this.id = id;
	this.name = name;
	...
	result = prime * result
		+ ((createdPlace == null) ? 0 : createdPlace.hashCode());
	result = prime * result
