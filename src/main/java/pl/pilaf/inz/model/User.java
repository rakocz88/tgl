...
public class User implements Serializable {
    ...
    public User(long id, String firstName, String lastName, Date birtDate,
	    String birthPlace, UserType userType, String login,
	    String password, String description, List<Band> bands) {
	super();
	this.id = id;
	...
	result = prime * result
		+ ((birtDate == null) ? 0 : birtDate.hashCode());
	result = prime * result
